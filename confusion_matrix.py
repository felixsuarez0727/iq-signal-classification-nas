...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python evaluate_model.py <model_path.keras> <test_data_folder>")
        sys.exit(1)
    ...
    # Load test dataset
    X_test, y_test = load_dataset(test_folder, CHUNK_SAMPLES)
    if X_test is None:
        print("❌ No test data found in", test_folder)
        sys.exit(1)
